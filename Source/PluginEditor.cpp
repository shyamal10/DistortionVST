...
void DistortionVSTAudioProcessorEditor::resized()
{
    ...
    driveKnob.setBounds(((getWidth() / 5) * 1) - (100/ 2 ), (getHeight() / 2) - (100 / 2), componentSize, componentSize);
    rangeKnob.setBounds(((getWidth() / 5) * 2) - (100/ 2 ), (getHeight() / 2) - (100 / 2), componentSize, componentSize);
    mixKnob.setBounds(((getWidth() / 5) * 3) - (100/ 2 ), (getHeight() / 2) - (100 / 2), componentSize, componentSize);
    volumeKnob.setBounds(((getWidth() / 5) * 4) - (100/ 2 ), (getHeight() / 2) - (100 / 2), componentSize, componentSize);
